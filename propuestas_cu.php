...
<link rel="stylesheet" href="css/fonts/style.css">
    ...
    <title>Propuestas de contraloría</title>
...
<br>
<div class="pu">
<h1 class=intro2 >Propuestas de contraloría <br><h1 class=intro3 >NOTA: Tienes que iniciar sesion en facebook para poder comentar y solo a los canditatos se les permite </h1> </h1> 
</div>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/es_LA/sdk.js#xfbml=1&version=v11.0" nonce="RzXgn2LX"></script>

<div class="fb-comments" data-href="http://localhost/vote_checker-main/propuestas_c.php" data-width="100%" data-numposts="5"></div>
