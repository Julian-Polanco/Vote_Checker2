...
<h1 class=intro2 >propuestas de contraloria <br><h1 class=intro3 >NOTA: Tienes que iniciar sesion en facebook para poder comentar y solo a los canditatos se les permite </h1> </h1> 
<div id="fb-root"></div>
